...
- 22-Aug  Introductions, Reproducible Research, R, Rstudio, Rmarkdown, $\LaTeX$  
- 29-Aug  Loading, munging and summarizing data in R, plus some Git  
- 5-Sep   R functions and logic, good programming practices  
- 12-Sep  Vector/matrix math, speed considerations  
- 19-Sep  R's apply family of functions  
*MODULE 2 -- Graphics in R*  
- 26-Sep  Base graphics, multipanel plots  
- 3-Oct   ggplot  
- 10-Oct  Dashboards  
- 17-Oct  Interactive visualizations  
*MODULE 3 -- Computing*  
- 24-Oct  Parallel computing in R, foreach and dopar  
- 31-Oct  Python and Jupyter notebooks  
- 7-Nov   Python II  
*MODULE 4 -- GUI driven stats*  
- 14-Nov  Intro to GUIs -- BlueSky and JMP  
* 21-Nov  _Thanksgiving Break_  
- 28-Nov  More GUIs -- JMP II and Orange  
- 5-Dec   From JMP to SAS  
* Final   None  
